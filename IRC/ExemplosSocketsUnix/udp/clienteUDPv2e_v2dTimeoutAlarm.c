...
O protocolo usado e' o UDP e o timeout e' baseado na rotina alarm().
==============================================================================*/
...
int main( int argc , char *argv[] )
{
	...
	/*=============== ASSOCIA O SINAL SIGALRM A TRATATIMEOUT()  ==============*/
...
/*_____________________________ trataTimeout___________________________________
  Rotina de tratamento do sinal SIGALRM
